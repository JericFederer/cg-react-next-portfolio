  ...
  return (
    <section className="w-full pt-10 pb-0">
      <h1 className="heading">
        My <span className="text-purple">Strategy</span>
      </h1>

      <div className="mt-12 sm:mt-20 mb-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          title="Investigation"
          icon={
            <AceternityIcon
          ...
          description="Whenever I am given a task, I try to analyze the design pattern and data flow from the front end to the back end as well as checking any possible area of the code base that might be affected."
        >
          <CanvasRevealEffect
            animationSpeed={ 5.1 }
        ...
        <Card
          ...
          description="After investigating, I take note of all my findings, list the solutions I will come up with, and decide which best suits the existing design pattern."
        >
          <CanvasRevealEffect
            animationSpeed={ 3 }
        ...
        <Card
          ...
          description="Once I have decided on which solution to implement, I write the code and make it readable as much as possible. Finally, I conduct operation tests and create test codes."
        >
          <CanvasRevealEffect
            animationSpeed={ 3 }
