            ...
            id === 3 && (
              <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
                <div className="flex flex-col gap-1 md:gap-3 lg:gap-3">
                  {
                    [
                      ["MERN Stack", "(React/React Native TypeScript)"],
                      ["React + NextJS", "(TypeScript)"],
                      ["React Native", "(TypeScript)"],
                      ["Swift UI", "(iOS, WatchOS)"]
                    ].map((item) => (
                      <span key={ item[1] } className="py-2 lg:py-2 lg:px-3 px-3 text-xs lg:text-sm opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]">
                        { item[0] }
                        <br />
                        { item[1] }
                      </span>
