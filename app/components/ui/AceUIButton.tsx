...
const AceUIButton = ({
  ...
  return (
    // * Shimmer Button
    <button className="gap-2 md:w-60 md:mt-10 lg:w-full lg:mt-3 my-3 lg:px-10 md:px-5 inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-slate-800 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] font-medium text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
      { position === "left" && icon }
      { title }
      { position === "right" && icon }
    </button>
